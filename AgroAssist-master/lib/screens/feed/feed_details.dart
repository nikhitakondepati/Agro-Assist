              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  return ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: snapshot.data!.docs.length, // Use snapshot.data!.docs.length
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      DocumentSnapshot feed = snapshot.data!.docs[index]; // Use snapshot.data!.docs[index]
                      FeedModel feedModel =
                      FeedModel.fromJson(feed.data() as Map<String, dynamic>); // Use feed.data() instead of feed.data
