...
class _FirebaseRealtimeDemoScreenState
      ...
      children: <Widget>[
        new TextFormField(
          ...
          decoration: new InputDecoration(
              hintText:
                  AppLocalizations.of(context)?.translate('Air Humidity')),
          maxLength: 32,
          validator: validateName,
          onSaved: (String? val) {
            if (val != null) ahumid = double.parse(val);
          },
        ),
        new TextFormField(
            decoration: new InputDecoration(
            ...
            onSaved: (String? val) {
              if (val != null) atemp = double.parse(val);
            }),
        new TextFormField(
            decoration: new InputDecoration(
            ...
            onSaved: (String? val) {
              if (val != null) rainfall = double.parse(val);
            }),
        new TextFormField(
          keyboardType: TextInputType.number,
          decoration: new InputDecoration(
          ...
          validator: validateName,
          onSaved: (String? val) {
            if (val != null) shumid = double.parse(val);
          },
        ),
        new TextFormField(
          keyboardType: TextInputType.number,
          ...
          validator: validateName,
          onSaved: (String? val) {
            if (val != null) sph = double.parse(val);
          },
        ),
  ...
  void readData() {
    databaseReference.child("Realtime").once().then((event) {
