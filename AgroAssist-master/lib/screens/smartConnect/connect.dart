        ...
        body: StreamBuilder<dynamic>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              var docs = snapshot.data!.docs; // Use snapshot.data!.docs instead of snapshot.data.documents
              return ListView.builder(
                itemCount: docs.length, // Use docs.length instead of snapshot.data.documents.length
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  DocumentSnapshot crop = docs[index]; // Use docs[index] instead of snapshot.data.documents[index]
                  CropModel cropModel =
                  CropModel.fromJson(crop.data() as Map<String, dynamic>); // Use crop.data() instead of crop.data
